...
var _ resource.ResourceWithImportState = (*redshift_catalogResource)(nil)
...
func (r *redshift_catalogResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	s := resource_redshift_catalog.RedshiftCatalogResourceSchema(ctx)
...
func (r *redshift_catalogResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	tflog.Debug(ctx, "Created redshift_catalog", map[string]interface{}{"id": plan.CatalogId.ValueString()})
...
func (r *redshift_catalogResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Debug(ctx, "Updated redshift_catalog", map[string]interface{}{"id": plan.CatalogId.ValueString()})
	resp.Diagnostics.Append(resp.State.Set(ctx, &plan)...)
}
...
func (r *redshift_catalogResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
