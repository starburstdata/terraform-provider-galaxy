	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"description": schema.StringAttribute{
				...
				MarkdownDescription: "Policy description (read only)",
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "Policy name (read only)",
			},
			...
			"predicate": schema.StringAttribute{
				...
				MarkdownDescription: "Policy predicate (read only)",
			},
			"role_id": schema.StringAttribute{
				Required:            true,
				Description:         "Enabling role id (read only)",
				MarkdownDescription: "Enabling role id (read only)",
			},
