...
package datasource_mongodb_catalog_validation
...
func MongodbCatalogValidationDataSourceSchema(ctx context.Context) schema.Schema {
...
type MongodbCatalogValidationModel struct {
