...
package datasource_data_quality_summaries
...
func DataQualitySummariesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"catalog_summaries": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"catalog_name": schema.StringAttribute{
							...
							MarkdownDescription: "Catalog name (read only)",
						},
					...
					CustomType: CatalogSummariesType{
						ObjectType: types.ObjectType{
							AttrTypes: CatalogSummariesValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed:            true,
				Description:         "Summaries per catalog (read only)",
				MarkdownDescription: "Summaries per catalog (read only)",
			},
...
type DataQualitySummariesModel struct {
	CatalogSummaries types.List `tfsdk:"catalog_summaries"`
...
var _ basetypes.ObjectTypable = CatalogSummariesType{}

type CatalogSummariesType struct {
	basetypes.ObjectType
}

func (t CatalogSummariesType) Equal(o attr.Type) bool {
	other, ok := o.(CatalogSummariesType)
...
func (t CatalogSummariesType) String() string {
	return "CatalogSummariesType"
}

func (t CatalogSummariesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
...
func NewCatalogSummariesValueNull() CatalogSummariesValue {
	return CatalogSummariesValue{
		state: attr.ValueStateNull,
	}
}

func NewCatalogSummariesValueUnknown() CatalogSummariesValue {
	return CatalogSummariesValue{
		state: attr.ValueStateUnknown,
	}
}

func NewCatalogSummariesValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (CatalogSummariesValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing CatalogSummariesValue Attribute Value",
				"While creating a CatalogSummariesValue value, a missing attribute value was detected. "+
					"A CatalogSummariesValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("CatalogSummariesValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid CatalogSummariesValue Attribute Type",
				"While creating a CatalogSummariesValue value, an invalid attribute value was detected. "+
					"A CatalogSummariesValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("CatalogSummariesValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("CatalogSummariesValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra CatalogSummariesValue Attribute Value",
				"While creating a CatalogSummariesValue value, an extra attribute value was detected. "+
					"A CatalogSummariesValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra CatalogSummariesValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewCatalogSummariesValueUnknown(), diags
	}
...
func NewCatalogSummariesValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) CatalogSummariesValue {
	object, diags := NewCatalogSummariesValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewCatalogSummariesValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t CatalogSummariesType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewCatalogSummariesValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewCatalogSummariesValueUnknown(), nil
	}
	...
	return NewCatalogSummariesValueMust(CatalogSummariesValue{}.AttributeTypes(ctx), attributes), nil
}

func (t CatalogSummariesType) ValueType(ctx context.Context) attr.Value {
	return CatalogSummariesValue{}
}

var _ basetypes.ObjectValuable = CatalogSummariesValue{}

type CatalogSummariesValue struct {
...
func (v CatalogSummariesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v CatalogSummariesValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v CatalogSummariesValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v CatalogSummariesValue) String() string {
	return "CatalogSummariesValue"
}

func (v CatalogSummariesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v CatalogSummariesValue) Equal(o attr.Value) bool {
	other, ok := o.(CatalogSummariesValue)
...
func (v CatalogSummariesValue) Type(ctx context.Context) attr.Type {
	return CatalogSummariesType{
		basetypes.ObjectType{
...
func (v CatalogSummariesValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
