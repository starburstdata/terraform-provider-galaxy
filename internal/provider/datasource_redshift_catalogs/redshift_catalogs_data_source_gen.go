...
package datasource_redshift_catalogs
...
func RedshiftCatalogsDataSourceSchema(ctx context.Context) schema.Schema {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"catalog_id": schema.StringAttribute{
							Computed:            true,
							Description:         "Redshift catalog identifier (read only)",
							MarkdownDescription: "Redshift catalog identifier (read only)",
						},
...
type RedshiftCatalogsModel struct {
