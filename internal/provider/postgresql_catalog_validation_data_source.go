...
import (
	...
	"github.com/starburstdata/terraform-provider-galaxy/internal/provider/datasource_postgresql_catalog_validation"
)

var _ datasource.DataSource = (*postgresql_catalog_validationDataSource)(nil)
var _ datasource.DataSourceWithConfigure = (*postgresql_catalog_validationDataSource)(nil)

func NewPostgresqlCatalogValidationDataSource() datasource.DataSource {
	return &postgresql_catalog_validationDataSource{}
}

type postgresql_catalog_validationDataSource struct {
	client *client.GalaxyClient
}

func (d *postgresql_catalog_validationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_postgresql_catalog_validation"
}

func (d *postgresql_catalog_validationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_postgresql_catalog_validation.PostgresqlCatalogValidationDataSourceSchema(ctx)
}

func (d *postgresql_catalog_validationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *postgresql_catalog_validationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config datasource_postgresql_catalog_validation.PostgresqlCatalogValidationModel
