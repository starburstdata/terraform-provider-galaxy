...
package datasource_gcs_catalog_validation
...
func GcsCatalogValidationDataSourceSchema(ctx context.Context) schema.Schema {
...
type GcsCatalogValidationModel struct {
