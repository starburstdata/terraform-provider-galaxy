...
var _ resource.ResourceWithImportState = (*cassandra_catalogResource)(nil)
...
func (r *cassandra_catalogResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	s := resource_cassandra_catalog.CassandraCatalogResourceSchema(ctx)
...
func (r *cassandra_catalogResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
