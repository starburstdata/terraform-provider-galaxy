...
package datasource_s3_catalog_validation
...
func S3CatalogValidationDataSourceSchema(ctx context.Context) schema.Schema {
...
type S3CatalogValidationModel struct {
