...
package datasource_cassandra_catalogs
...
func CassandraCatalogsDataSourceSchema(ctx context.Context) schema.Schema {
...
type CassandraCatalogsModel struct {
...
func (t ResultType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	contactPointsAttribute, ok := attributes["contact_points"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`contact_points is missing from object`)

		return nil, diags
	}

	contactPointsVal, ok := contactPointsAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`contact_points expected to be basetypes.StringValue, was: %T`, contactPointsAttribute))
	}

	databaseIdAttribute, ok := attributes["database_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`database_id is missing from object`)

		return nil, diags
	}

	databaseIdVal, ok := databaseIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`database_id expected to be basetypes.StringValue, was: %T`, databaseIdAttribute))
	}

	deploymentTypeAttribute, ok := attributes["deployment_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`deployment_type is missing from object`)

		return nil, diags
	}

	deploymentTypeVal, ok := deploymentTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`deployment_type expected to be basetypes.StringValue, was: %T`, deploymentTypeAttribute))
	}
	...
	localDatacenterAttribute, ok := attributes["local_datacenter"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`local_datacenter is missing from object`)

		return nil, diags
	}

	localDatacenterVal, ok := localDatacenterAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`local_datacenter expected to be basetypes.StringValue, was: %T`, localDatacenterAttribute))
	}
	...
	return ResultValue{
		...
		ContactPoints:   contactPointsVal,
		DatabaseId:      databaseIdVal,
		DeploymentType:  deploymentTypeVal,
		Description:     descriptionVal,
		LocalDatacenter: localDatacenterVal,
		Name:            nameVal,
...
type ResultValue struct {
	...
	ContactPoints   basetypes.StringValue `tfsdk:"contact_points"`
	DatabaseId      basetypes.StringValue `tfsdk:"database_id"`
	DeploymentType  basetypes.StringValue `tfsdk:"deployment_type"`
	Description     basetypes.StringValue `tfsdk:"description"`
	LocalDatacenter basetypes.StringValue `tfsdk:"local_datacenter"`
...
func (v ResultValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["contact_points"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["database_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["deployment_type"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["description"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["local_datacenter"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ContactPoints.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["contact_points"] = val

		val, err = v.DatabaseId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["database_id"] = val

		val, err = v.DeploymentType.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["deployment_type"] = val
		...
		val, err = v.LocalDatacenter.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["local_datacenter"] = val
...
func (v ResultValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"contact_points":   basetypes.StringType{},
		"database_id":      basetypes.StringType{},
		"deployment_type":  basetypes.StringType{},
		"description":      basetypes.StringType{},
		"local_datacenter": basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"contact_points":   v.ContactPoints,
			"database_id":      v.DatabaseId,
			"deployment_type":  v.DeploymentType,
			"description":      v.Description,
			"local_datacenter": v.LocalDatacenter,
			"name":             v.Name,
			"password":         v.Password,
			"port":             v.Port,
...
func (v ResultValue) Equal(o attr.Value) bool {
	...
	if !v.ContactPoints.Equal(other.ContactPoints) {
		return false
	}

	if !v.DatabaseId.Equal(other.DatabaseId) {
		return false
	}

	if !v.DeploymentType.Equal(other.DeploymentType) {
		return false
	}
	...
	if !v.LocalDatacenter.Equal(other.LocalDatacenter) {
		return false
	}
