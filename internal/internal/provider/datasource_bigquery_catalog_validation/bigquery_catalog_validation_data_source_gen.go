...
package datasource_bigquery_catalog_validation
...
func BigqueryCatalogValidationDataSourceSchema(ctx context.Context) schema.Schema {
...
type BigqueryCatalogValidationModel struct {
