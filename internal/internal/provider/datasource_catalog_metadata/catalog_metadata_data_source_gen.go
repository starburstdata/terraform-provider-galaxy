...
package datasource_catalog_metadata
...
func CatalogMetadataDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"contacts": schema.ListNestedAttribute{
				...
				MarkdownDescription: "Any contacts set for this catalog (read only)",
			},
			...
			"tags": schema.ListNestedAttribute{
				...
				MarkdownDescription: "Any tags set for this catalog (read only)",
			},
		},
	}
}

type CatalogMetadataModel struct {
