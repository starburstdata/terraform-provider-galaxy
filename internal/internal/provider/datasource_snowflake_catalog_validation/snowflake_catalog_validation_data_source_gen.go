...
package datasource_snowflake_catalog_validation
...
func SnowflakeCatalogValidationDataSourceSchema(ctx context.Context) schema.Schema {
...
type SnowflakeCatalogValidationModel struct {
